    ...
    >
      <div className="w-full h-full md:px-20 px-5">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-blue-600">
            Work Experience
          </h1>
        ...
        <div className="mt-32 relative">
          ...
          <div className="xl:w-7/9 text-center pt-12">
            <motion.div
            ...
            >
              <Button
                ...
                colour="bg-gradient-to-r from-teal-400 to-blue-600"
              />
            </motion.div>
          </div>
        </div>
